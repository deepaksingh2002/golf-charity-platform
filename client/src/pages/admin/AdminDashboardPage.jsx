...
export default function AdminDashboardPage() {
  ...
  if (loading || !stats) return <div className="flex justify-center p-12"><Spinner /></div>;
  ...
  const statCards = [
    ...
    { label: 'Pending Verifications', value: 0, icon: <AlertCircle size={20} />, color: 'text-orange-600', bg: 'bg-orange-100' },
  ];
